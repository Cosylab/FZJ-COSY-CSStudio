 ...
 * 
 * This is a copy of the class {@link NumberAxis}, but modified in a way so that the negative tick marks are not
 * displayed.
 * 
 * @since JavaFX 2.0
 * 
 */
public final class SpecialNumberAxis extends ValueAxis<Number> {
    ...
    private DoubleProperty tickUnit = new StyleableDoubleProperty(5) {
        ...
        @Override
        public CssMetaData<SpecialNumberAxis, Number> getCssMetaData() {
    ...
    /**
     * Create a auto-ranging SpecialNumberAxis
     */
    public SpecialNumberAxis() {
    }

    /**
     * Create a non-auto-ranging SpecialNumberAxis with the given upper bound, lower bound and tick unit
     *
     * @param lowerBound
     ...
     */
    public SpecialNumberAxis(double lowerBound, double upperBound, double tickUnit) {
     ...
     *            The tick unit, ie space between tickmarks
     */
    public SpecialNumberAxis(String axisLabel, double lowerBound, double upperBound, double tickUnit) {
        super(lowerBound, upperBound);
        setTickUnit(tickUnit);
        setLabel(axisLabel);
    }
    ...
    protected List<Number> calculateTickValues(double length, Object range) {
        ...
        if (lowerBound == upperBound) {
            ...
            if (((upperBound - lowerBound) / tickUnit) > 2000) {
                ...
                System.err.println("Warning we tried to create more than 2000 major tick marks on a SpecialNumberAxis. "
    ...
    protected List<Number> calculateMinorTickMarks() {
        ...
        if (tickUnit > 0) {
            if (((upperBound - lowerBound) / minorUnit) > 10000) {
                // This is a ridiculous amount of major tick marks, something has probably gone wrong
                System.err
                        .println("Warning we tried to create more than 10000 minor tick marks on a SpecialNumberAxis. "
    ...
    private static class StyleableProperties {
        private static final CssMetaData<SpecialNumberAxis, Number> TICK_UNIT = new CssMetaData<SpecialNumberAxis, Number>(
                "-fx-tick-unit", SizeConverter.getInstance(), 5.0) {

            @Override
            public boolean isSettable(SpecialNumberAxis n) {
                return n.tickUnit == null || !n.tickUnit.isBound();
            }

            @Override
            public StyleableProperty<Number> getStyleableProperty(SpecialNumberAxis n) {
    ...
    /**
     * Default number formatter for SpecialNumberAxis, this stays in sync with auto-ranging and formats values
     * appropriately. You can wrap this formatter to add prefixes or suffixes;
     * 
     * @since JavaFX 2.0
     */
    public static class DefaultFormatter extends StringConverter<Number> {
        ...
        /**
         * Construct a DefaultFormatter for the given SpecialNumberAxis
         *
         * @param axis
         *            The axis to format tick marks for
         */
        public DefaultFormatter(final SpecialNumberAxis axis) {
        ...
        /**
         * Construct a DefaultFormatter for the given SpecialNumberAxis with a prefix and/or suffix.
         *
         * @param axis
         *            The axis to format tick marks for
         * @param prefix
         ...
         */
        public DefaultFormatter(SpecialNumberAxis axis, String prefix, String suffix) {
            this(axis);
            this.prefix = prefix;
            this.suffix = suffix;
        }
